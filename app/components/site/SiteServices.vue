...
<template>
  <section id="services" class="max-w-[1200px] mx-auto px-4 py-16 md:px-6 md:py-20 lg:px-12 lg:py-[100px]">
    ...
    <header class="mb-16" data-reveal>
      ...
      <h2 class="font-display text-[clamp(28px,3.8vw,46px)] font-extrabold tracking-[-2px] text-(--theme-fg) leading-[1.05]">
        ...
        <br>
        <em class="font-headline italic text-(--theme-accent)">as you do</em>
      </h2>
    </header>
      ...
      <div
        ...
        <LumenSurface
          ...
          <div class="flex flex-col gap-5 p-8 md:p-10 flex-1 relative">
            <span
              class="absolute top-4 right-6 font-display text-[80px] font-extrabold leading-none select-none pointer-events-none text-(--theme-fg) opacity-[0.07] group-hover:opacity-[0.15] transition-opacity duration-500">
              0{{ i + 1 }}
            </span>
            ...
            <div class="flex flex-col gap-2 flex-1">
              <h3 class="font-display text-[22px] font-bold tracking-[-0.5px] leading-tight text-(--theme-fg)">
                {{ svc.title }}
              </h3>
              <p class="text-[14px] leading-[1.88] max-w-[320px] text-(--theme-text-body)">
                {{ svc.body }}
              </p>
            </div>
