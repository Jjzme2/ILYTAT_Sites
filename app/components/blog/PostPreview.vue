...
const postVars = computed(() => ({
  '--accent': props.post.style?.accentColor || 'var(--theme-accent)',
...
.post-hero {
  ...
  text-align: center; border-bottom: 1px solid var(--glass-card-border);
}
.hero-gradient {
  background:
...
.post-heading {
  font-size: clamp(1.4rem, 3.5vw, 2.2rem); font-weight: 800; color: var(--theme-fg);
...
.preview-empty { color: var(--theme-text-ghost); font-size: 14px; font-style: italic; text-align: center; padding: 40px 0; }

/* Prose */
.prose { line-height: 1.8; color: var(--theme-text-hi); font-size: clamp(14px, 1.8vw, 16px); }
:deep(.prose h1) { font-size: 1.9em; font-weight: 800; color: var(--theme-fg); margin: 1.2em 0 .4em; }
:deep(.prose h2) { font-size: 1.45em; font-weight: 700; color: var(--theme-fg); margin: 1.1em 0 .4em; border-bottom: 1px solid var(--glass-card-border); padding-bottom: .3em; }
:deep(.prose h3) { font-size: 1.15em; font-weight: 600; color: var(--theme-fg); margin: 1em 0 .3em; }
...
:deep(.prose pre) {
  background: var(--theme-surface-alt); border: 1px solid var(--glass-card-border); border-radius: 8px;
...
:deep(.prose hr) { border: none; border-top: 1px solid var(--glass-card-border); margin: 1.8em 0; }
...
:deep(.prose details summary) {
  cursor: pointer; padding: 10px 14px; font-weight: 600; color: var(--theme-text-hi);
