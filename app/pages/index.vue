...
<template>
  <div class="relative min-h-screen bg-[#0d0b09] text-[#f0ece6] font-sans leading-relaxed overflow-x-hidden">
    ...
    <section id="portfolio" class="max-w-[1080px] mx-auto px-12 py-[100px] md:px-6 md:py-20 sm:px-4 sm:py-16">
      ...
      <div v-if="projects?.length" class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3" data-reveal>
        <a
          ...
          class="glass-deep rounded-sm overflow-hidden flex flex-col no-underline text-inherit transition-[border-color,transform,box-shadow] duration-300 group"
          :class="proj.url ? 'hover:border-[rgba(245,197,24,0.22)] hover:-translate-y-1.5 hover:shadow-[0_20px_60px_rgba(0,0,0,0.5)]' : ''">
          <div class="aspect-video bg-[#080810] flex items-center justify-center overflow-hidden relative">
          ...
          <div class="px-6 pt-5 pb-6 flex flex-col gap-1.5">
            <span class="font-mono text-[8px] tracking-[2.5px] uppercase text-[#f5c518]/38 block">{{ proj.industry }}</span>
    ...
    <section
      ...
      <div class="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-4">
        <div
          ...
          :key="t.id"
          class="glass-deep rounded-sm px-7 py-8 flex flex-col gap-5 relative overflow-hidden transition-[border-color,transform,box-shadow] duration-300 hover:border-white/[0.14] hover:-translate-y-1.5 hover:shadow-[0_20px_60px_rgba(0,0,0,0.5)]"
          data-reveal
          ...
          <p class="text-[14.5px] text-[#a09894]/85 leading-[1.92] flex-1 italic relative z-[1]">"{{ t.quote }}"</p>
    ...
    <div class="relative mx-12 my-[100px] overflow-hidden rounded-sm md:mx-6 md:my-16 sm:mx-4 sm:my-12" data-reveal>
      ...
      <div class="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#f5c518]/60 to-transparent" />
      <div class="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/[0.04] to-transparent" />
      <div
        class="absolute inset-0 pointer-events-none"
        style="background: radial-gradient(ellipse 55% 110% at 50% -10%, rgba(245,197,24,0.055), transparent)"
        aria-hidden="true" />
      <div class="relative z-[1] text-center px-12 py-24 sm:px-6 sm:py-16">
        <p class="eyebrow justify-center">Ready to start?</p>
        <h2
          class="font-display text-[clamp(28px,4.2vw,56px)] font-extrabold tracking-[-2.5px] mt-2 mb-5 leading-[1.04] text-[#f0ece6]"
          style="white-space: pre-line">{{ siteContent.cta.headline }}</h2>
        <p class="text-[15px] text-[#6a6761] mb-10 max-w-[440px] mx-auto leading-[1.88]">{{ siteContent.cta.subtext }}</p>
        <a
          href="#contact"
          class="btn-primary"
